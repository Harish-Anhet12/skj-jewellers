<header class="h-20 bg-white border-b border-gold-100 flex items-center justify-between px-4 md:px-8">
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="hidden sm:flex items-center gap-3 bg-gold-50 border border-gold-200 px-3 py-1.5 rounded-full text-xs">
            ...
            <span class="font-semibold text-ink-900">22K Gold: <span class="text-gold-600 font-bold">₹6,589/gm</span></span>
            <span class="text-emerald-600 font-medium">▲ +₹25</span>
        ...
        <div class="flex items-center gap-2">
            <span class="w-10 h-10 rounded-full border border-gold-300 bg-gold-100 text-gold-700 font-semibold text-sm flex items-center justify-center" title="{{ config('brand.name') }}">VA</span>
        </div>
    </div>
</header>

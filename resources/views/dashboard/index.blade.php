    ...
    <div class="card p-6 md:col-span-2 flex flex-col sm:flex-row gap-6 items-center bg-gradient-to-br from-gold-50/50 to-white">
        ...
        <div>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="{{ url('/dashboard/pay-emi') }}" class="btn-outline !px-5 !py-2 text-xs">Add Gold Weight</a>
            </div>
        </div>
    </div>
...
<div class="grid md:grid-cols-2 gap-6">
    ...
    <div class="card p-6">
        ...
        <div class="grid grid-cols-2 gap-3 text-sm">
            <a href="{{ url('/dashboard/pay-emi') }}" class="btn-gold justify-center">Pay EMI Online</a>
